...
demo = gr.ChatInterface(
    ...
    examples=[
        ...
        "Як вигладала монета викорбована на честь скіфського царя та яким було його правління?",
        "Створи порівняльну таблицю політично-адміністративного устрою Запорізької Січі та Слобожанщини.",
    ],
    fill_height=True,
)
